...
Также за треть времени до конца задания вам придет напоминалка в личку, так что включите Омегалюля для себя!
""",
    "Работа": f"""
    <b>Работа</b>
Команды:
...
Также вы получите упоминание за час и при начале мероприятия в личку, так что включите Омегалюля для себя!
""",
    "Рейды": f"""
    <b>Рейды</b>
Команды:
...
Условия ачивок можно посмотреть только после их выполнения.""",
    "Диалог с Омегалюлем": f"""
    <b>Диалог</b>
Команды:
/talk - начать диалог с Омегалюлем.

После введения команды напишите боту любой вопрос.
Разговорный модуль Омегалюля основан на подключении ChatGPT.""",
    "Игра в кости": f"""
    <b>Игра в кости</b>
Команды:
